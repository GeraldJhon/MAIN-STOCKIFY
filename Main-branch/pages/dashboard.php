...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Cinzel+Decorative:wght@400;700;900&family=Electrolize&display=swap"
    rel="stylesheet" />
</head>
...
<body>
    ...
    <div class="modal-container modal-container--add-item">
      ...
      <form id="add-item-form" class="item-form">
        ...
        <div class="form-group">
          ...
          <input type="text" id="add-item-description" class="form-input" placeholder="Enter Description" required />
        </div>

        <div class="form-group">
          <label for="add-item-quantity" class="form-label">Quantity:</label>
          <input type="number" id="add-item-quantity" class="form-input" placeholder="Enter Quantity" required />
        </div>
    ...
    <div class="modal-container modal-container--update-item">
      ...
      <form id="update-item-form" class="item-form">
        ...
        <div class="form-group">
          ...
          <input type="text" id="update-item-description" class="form-input" placeholder="Update the description:" />
        </div>

        <div class="form-group">
          <label for="update-item-quantity" class="form-label">Qty:</label>
          <input type="number" id="update-item-quantity" class="form-input" placeholder="Update item quantity:" />
        </div>
    ...
    <table class="inventory-table">
      ...
      <tbody class="inventory-table-body">
        <tr class="inventory-row" data-item-id="001">
          ...
          <td class="inventory-cell inventory-cell--description">MSI Titan-18-HX-Dragon-Edition-Norse-Myth-A2XWX</td>
          <td class="inventory-cell inventory-cell--quantity">10 pcs</td>
          <td class="inventory-cell inventory-cell--actions">
            <button class="button button--action js-update-item" data-item-id="001">Update</button>
            <button class="button button--danger js-delete-item" data-item-id="001">Delete</button>
          </td>
        </tr>
        <tr class="inventory-row" data-item-id="002">
          ...
          <td class="inventory-cell inventory-cell--description">SANDISK 256GB ULTRA FLAIR USB3.0 (SDCZ73-256G-G46)
            Flash Drive (Black)
          </td>
          <td class="inventory-cell inventory-cell--quantity">5 pcs</td>
          <td class="inventory-cell inventory-cell--actions">
            <button class="button button--action js-update-item" data-item-id="002">Update</button>
            <button class="button button--danger js-delete-item" data-item-id="002">Delete</button>
          </td>
        </tr>
        <tr class="inventory-row" data-item-id="003">
          ...
          <td class="inventory-cell inventory-cell--actions">
            <button class="button button--action js-update-item" data-item-id="003">Update</button>
            <button class="button button--danger js-delete-item" data-item-id="003">Delete</button>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <!-- JavaScript -->
  <script src="../assets/js/add-items_container.js"></script>
</body>
